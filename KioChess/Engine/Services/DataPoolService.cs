...
public class DataPoolService 
{
    ...
    private readonly MoveHistoryList[] _moveHistoryLists;
        ...
        MoveProvider moveProvider, IKillerMoveCollectionFactory killerMoveCollectionFactory)
    {
        ...
        _moveHistoryLists = new MoveHistoryList[gameDepth];
        ...
        for (int i = 0; i < popularDepth; i++)
        {
            ...
            _moveHistoryLists[i] = new MoveHistoryList();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public MoveHistoryList GetCurrentMoveHistoryList() => _moveHistoryLists[_moveHistory.GetPly()];
