...
/// Returns a TextBlock with highlighted (bold + accent colored) matching portions.
/// </summary>
public class HighlightTextConverter : IMultiValueConverter
{
    public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        // Find all occurrences of query in text and highlight them
        while ((matchIndex = textLower.IndexOf(queryLower, currentIndex, StringComparison.OrdinalIgnoreCase)) >= 0)
        {
            ...
            // Add highlighted match (bold + accent color)
