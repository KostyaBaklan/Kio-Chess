...
{
    public class EndGameSorter : InitialSorterBase<EndGameMoveCollection>
    {
        public EndGameSorter(IPosition position, IMoveComparer comparer) : base(position, comparer)
        {
        }
        ...
        internal override void ProcessWhiteEndMove(MoveBase move)
        {
            ...
            {
                AttackCollection.AddPassed(move);
            }
            else
            {
                AttackCollection.AddNonCapture(move);
        ...
        {
            AttackCollection = new EndGameMoveCollection(Comparer);
        }
    }
}
