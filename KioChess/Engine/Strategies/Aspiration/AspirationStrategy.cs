...
public class AspirationStrategy : StrategyBase
{
    protected List<AspirationModel> Models;

    public AspirationStrategy(short depth, Position position, TranspositionTable table = null) : base(depth, position, table)
    {
        Models = [];
